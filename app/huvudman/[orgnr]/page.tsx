...
import { HuvudmanDetail } from "./HuvudmanDetail";

interface Props {
  params: Promise<{ orgnr: string }>;
}

export default async function HuvudmanPage({ params }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/gymnasium" className="text-sm text-sky-700 hover:underline">← Tillbaka till gymnasie-rankning</Link>
