...
const STATISTICS_SOURCE_BY_BOARD_NAME: Record<string, string> = {
  ...
  "Antagningskansli Europaskolan Strängnäs": "europaskolan-strangnas",
  "Antagningskansliet för Karlshamn, Olofström och Ronneby": "skanegy",
  "Antagningskansliet i Ljungby": "kronoberg",
  "Antagningskansliet i Markaryd": "kronoberg",
  "Antagningskansliet i Nyköping": "nykoping",
  "Antagningskansliet i Oskarshamn": "oskarshamn",
  "Antagningskansliet Torsås": "torsas-korr",
  "Antagningskansliet Värmland": "varmland",
  "Antagningskansliet i Västervik": "vastervik",
  "Antagningskansliet Växjö": "kronoberg",
  "Gymnasieantagning Nord": "gymnasieantagning-nord",
